...
resource "google_sql_database_instance" "compliant-mysqlvbs" {
  name             = "compliant-mysqlvbs"
...
resource "google_sql_database_instance" "not-compliant-mysqlvbs" {
  name             = "not-compliant-mysqlvbs"
  database_version = "MYSQL_8_0"
  region           = "europe-west3"
  deletion_protection = false
